...
class resListAdapter (private val items: Array<String?>,
                      private val items2:Array<String?>,
                      private val items3: Array<String?>,
                      private val items4: Array<String?>,
                      private val user: String,
                      private val userid: String, private val usernam: String, private val context: Context): RecyclerView.Adapter<NewsViewHolder>(){
