...
public class tableconnector extends AsyncTask <String, Integer, String>{
    @Override
    protected String doInBackground(String... strings) {
        String constr = "https://isproj2b.benilde.edu.ph/ReservEat/mobileTable.php";
        URL url = null;
        ...
        try {
            postdata.append(URLEncoder.encode("restaurant","UTF-8"));
            postdata.append("=");
