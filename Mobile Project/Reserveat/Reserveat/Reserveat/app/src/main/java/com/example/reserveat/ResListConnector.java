...
public class ResListConnector extends AsyncTask<String, Integer, String> {
    @Override
    protected String doInBackground(String... strings) {
        String constr = "https://isproj2b.benilde.edu.ph/ReservEat/mobileReserveList.php";
        URL url = null;
        ...
        try {
            postdata.append(URLEncoder.encode("rest","UTF-8"));
            postdata.append("=");
